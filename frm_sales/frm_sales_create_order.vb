...
Public Class frm_sales_create_order
    ...
    Private Sub ClearFields()
        ...
        lbl_cid.Text = ""
        cbb_customer.SelectedIndex = -1
        lbl_account_type.Text = ""
        lbl_credits_available.Text = ""
                ...
                If e.ColumnIndex.Equals(4) Then
                    ...
                    If Not frm_main.user_role_id.Text.Equals("1") Then 'IF NOT ADMIN
                        If discount_counter > 2 Then
                            ...
                            Using conn
                                conn.Open()
                                Dim cmd = New MySqlCommand("SELECT COUNT(*)Then FROM ims_users WHERE role_id='1' AND pass=@pass", conn)
    ...
    Private Sub btn_save_Click(sender As Object, e As EventArgs) Handles btn_create.Click
        ...
        If Not (String.IsNullOrEmpty(cbb_customer.Text) Or String.IsNullOrEmpty(txt_billing.Text) Or grid_order.Rows.Count <= 1) Then
