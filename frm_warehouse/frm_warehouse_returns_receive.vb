    ...
    Private Sub load_data()
        Try
            Using conn = New MySqlConnection(str)
                ...
                Using cmd = New MySqlCommand("SELECT units
            ...
            Try
                Using conn = New MySqlConnection(str)
                    ...
                    If counter = grid_returns_view.RowCount Then
                        Using cmd_update_sr = New MySqlCommand("UPDATE ims_sales_returns SET status='Received', received_by=@user WHERE sales_return_id=@srid", conn)
                            cmd_update_sr.Parameters.AddWithValue("@user", frm_main.user_id.Text)
